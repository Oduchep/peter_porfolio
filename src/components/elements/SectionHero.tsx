      ...
      <div className='grid gap-10 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.9fr)] xl:items-start'>
        ...
        {aside && (
          <div className='relative'>
            ...
            <div className='rounded-[2.1rem] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(248,250,252,0.98)_100%)] p-5 shadow-[0_22px_70px_rgba(15,23,42,0.08)] md:p-8 dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.06)_0%,rgba(255,255,255,0.03)_100%)]'>
              {aside}
            </div>
          </div>
        )}
