...
const HomeHero = () => {
  ...
  return (
    ...
    >
      <div className='absolute top-12 left-8 -z-10 h-56 w-56 rounded-full bg-[radial-gradient(circle,rgba(41,64,104,0.18),transparent_72%)] blur-3xl dark:bg-[radial-gradient(circle,rgba(211,233,122,0.14),transparent_72%)]' />
      ...
      <div className='space-y-8'>
        ...
        <p className='text-sm tracking-[0.24em] text-slate-500 uppercase dark:text-white/45'>
