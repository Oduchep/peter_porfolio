  ...
  return (
    <Wrapper className='space-y-10'>
      ...
      <div className='grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]'>
        <div className='rounded-4xl border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(248,250,252,0.98)_100%)] p-6 shadow-[0_22px_70px_rgba(15,23,42,0.06)] md:p-8 dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.05)_0%,rgba(255,255,255,0.03)_100%)]'>
          ...
          <div className='mt-8 rounded-[1.6rem] border border-slate-200/70 bg-white/70 p-5 dark:border-white/10 dark:bg-white/3'>
